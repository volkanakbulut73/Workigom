...
export const mockJobs: Job[] = [
  ...
  },
  {
    ...
    duration: '3 saat',
    urgency: 'medium',
    description: 'Yarın klima montajı için yardımcı eleman aranıyor. Teknik bilgi ve deneyim gerekli.',
  ...
  },
  {
    ...
    duration: '5 saat',
    urgency: 'medium',
    description: 'Hafta sonu etkinliği için genel organizasyon desteği. Kurulum ve söküm işlerinde yardım.',
